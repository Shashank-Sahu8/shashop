...
class allproductscl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pro=productdata.allProduct;
    return GridView.builder(
      shrinkWrap: true,
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 7,crossAxisSpacing: 10,mainAxisExtent: 260,childAspectRatio: 0.7),
