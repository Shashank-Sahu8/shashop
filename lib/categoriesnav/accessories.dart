...
import 'package:finallyshop/categoriesdis/gadgetss.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Align(
            ...
            child: Text("Accessories",style: TextStyle(color: Colors.black87,fontSize: 24),)),
        actions: [
      ...
      body: SingleChildScrollView(
        ...
        child: new Column(
          children: [
            ...
            Padding(padding: EdgeInsets.only(top: 5),child: gadgetss())
